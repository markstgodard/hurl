...
class TraktTest < ActiveSupport::TestCase
  ...
  test "search by episode" do
    ...
    assert_equal "http://slurm.trakt.us/images/fanart/126.55.jpg",
                  json[:art]

    # this will be the screen shot not the regular poster
    assert_equal "http://slurm.trakt.us/images/episodes/126-5-12.55.jpg",
                  json[:poster]
  ...
  test "search by tv show" do
    ...
    assert_equal "http://slurm.trakt.us/images/posters/126.55.jpg",
                  json[:poster]
  end
